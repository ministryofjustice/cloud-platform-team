...
import (
	...
	scheme "github.com/ministryofjustice/cloud-platform-team-operator/pkg/client/clientset/versioned/scheme"
...
func newTeams(c *Cloud-platformV1Client, namespace string) *teams {
	return &teams{
		client: c.RESTClient(),
		ns:     namespace,
	}
